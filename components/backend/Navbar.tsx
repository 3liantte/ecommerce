...
export default function Navbar() {
    ...
    return (
        <div className="flex z-20 items-center bg-slate-300 dark:bg-slate-900 justify-between text-slate-900 dark:text-slate-50 h-16 px-8 py-4 fixed top-0 w-full">
            {/* Menu Icon */}
            <div>
